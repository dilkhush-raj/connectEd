...
export default function VideoPlayer({videoUrl}: {videoUrl: string}) {
  ...
  return (
    <div className="relative overflow-hidden rounded-[28px] bg-[#1E1E1E]">
      <img src={videoUrl} alt="video" className="aspect-video w-full" />

      <div className="absolute bottom-0 left-0 right-0 h-[115.50px] w-full rounded-bl-[28px] rounded-br-[28px] bg-gradient-to-b from-[#14143400] to-[#131434]" />
